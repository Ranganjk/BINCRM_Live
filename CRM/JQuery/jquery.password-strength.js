...
(function($) {
    ...
    $.fn.password_strength = function(options) {
        ...
        return this.each(function() {
            ...
            .css({ position: 'absolute', top: barTopPos - 6, left: barLeftPos + 175, 'font-size': '75%', display: 'inline-block', width: password_settings.barWidth + 40 });
            ...
            .eq(0).css({ height: 3, top: barTopPos - 16, left: barLeftPos + 175, 'border-style': 'solid', 'border-width': 1, padding: 2 }).end()
            .eq(1).css({ height: 5, top: barTopPos - 14, left: barLeftPos + 177 }).end()
