    ...
    var methods = {
        ...
        */
        _validateFields: function(form, skipAjaxValidation) {
            ...
            /*Added by Sathasivam to clear watermark text after successful submission of form*/
            form.find('[class*=water]').each(function() {
                var field = $(this);
        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "required":
                        if (field.val() == field.attr("title")) {
                            required = true; errorMsg = "*This field is required";
                        }
                        else {
                            required = true; errorMsg = methods._required(field, rules, i, options);
                        }
                        break;
                    case "custom":
        ...
        */
        _customRegex: function(field, rules, i, options) {
            ...
            //Modified by Sathasivam on 18-Nov-2013 to avoid pattern check if there is a tooltip
            if (!pattern.test(field.val()) && field.val() != field.attr("title")) {
