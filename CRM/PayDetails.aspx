<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PayDetails.aspx.cs" Inherits="PayDetails" %>
    ...
    <script type="text/javascript">
        ...
        function calTax(e) {
            ...
            if ((key < 48 || key > 57) & (key != 8) & (key != 190) & (key < 96 || key > 105)) {
                ...
                if (amt > 0) {
                    //stax = Math.round((amt/115) * (ServiceTax / 100));
                    //sbcess = Math.round((amt/115) * (SwaachBhCess / 100));
            ...
            <td>
                    ...
                    <div class="divCenter">
                         ...
                         <table cellpadding="5px;">
                            ...
                            <tr style="color: darkblue;">
                                <td>Swachh Bharat Tax<span style="color: red;"> *</span>
                                </td>
                                <td>:</td>
                                <td>
            ...
            <td align="center" colspan="2">
                                        ...
                                        <MasterTableView>
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridBoundColumn HeaderText="Swachh Bharat Tax" DataField="SwtchBharatTax" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"
                                                    ItemStyle-Wrap="false">
                                                    <ItemStyle ForeColor="darkBlue" Font-Names="Verdana" Font-Size="8" />
                                                    <HeaderStyle Width="150px" />
                                                </telerik:GridBoundColumn>
