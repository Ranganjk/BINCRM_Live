<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PayLogin.aspx.cs" Inherits="PayLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="cover" align="center">
        <table style="width: 100%; border: 1px solid #213042;" cellpadding="10">
            ...
            <caption style="background-color: #006BB2; text-align: center; padding: 5px; color: #FFFFFF; font-family: Verdana; font-size: 16px; font-weight: 700;">Recharge Summary</caption>
            <tr>
                <td></td>
            </tr>
